...
from .base_client import DEFAULT_TIMEOUT, BaseFirecrawlClient
from .core import AsyncHttpClient, AsyncHttpxClient, AsyncRawClient, BearerAuthScheme, no_auth


class AsyncFirecrawlClient(BaseFirecrawlClient[AsyncRawClient]):
    def __init__(
        self,
        *,
...
AsyncClient = AsyncFirecrawlClient
