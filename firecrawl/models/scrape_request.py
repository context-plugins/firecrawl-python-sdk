...
from .unions.format1 import Format1, Format1Dict
from .unions.redact_pii import RedactPii, RedactPiiDict


class ScrapeRequest(SdkBaseModel):
    url: str
    """The URL to scrape"""

    formats: Optional[list[Format1]] = UNSET
    ...
    """If true, this will enable zero data retention for this scrape. To enable this feature, please contact
    help@firecrawl.dev"""


class ScrapeRequestDict(TypedDict):
    url: str
    formats: NotRequired[list[Format1 | Format1Dict]]
