...
GetCrawlStatusErrorBody: TypeAlias = Crawl402Error1 | Crawl429Error1 | Crawl500Error1 | RawError


@dataclass(frozen=True, slots=True)
class _GetCrawlStatusError:
    def map(self, response: HttpResponse) -> GetCrawlStatusErrorBody:
...
get_crawl_status_error_mapper: Final[ErrorMapper[GetCrawlStatusErrorBody]] = _GetCrawlStatusError()
