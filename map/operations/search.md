...
Accessor: `client.search` · Source: `firecrawl/apis/search.py` · 2 operations
...
| Type | Source |
| --- | --- |
| `SearchRequest` | `firecrawl/models/search_request.py` |
| `SearchRequestDict` | `firecrawl/models/search_request.py` |
| `SearchResponse` | `firecrawl/models/search_response.py` |
| `SearchAndScrapeErrorBody` | `firecrawl/errors/search_and_scrape_error.py` |
| `Search408Error1` | `firecrawl/models/search408_error1.py` |
| `Search500Error1` | `firecrawl/models/search500_error1.py` |
